...
use crate::services::course::domain::{CoursePlan, ExtractedIdeas};
use crate::services::course::parser::parse_course_plan;
use crate::services::course::prompt::build_course_plan_prompt;
