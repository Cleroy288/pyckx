...
impl QcmRepository for StubQcmRepository {
    ...
    async fn update(&self, set: &QcmSet) -> Result<bool, StudyError> {
        let mut sets = self.sets.lock().unwrap();
...
impl crate::infra::CourseRepository for StubCourseRepository {
    async fn create_course(
        &self,
        course: &crate::services::course::domain::Course,
    ) -> Result<crate::services::course::domain::Course, AppError>
    {
        Ok(course.clone())
    }
    async fn get_user_courses(
        &self,
        _: &str,
    ) -> Result<Vec<crate::services::course::domain::Course>, AppError>
    {
        Ok(vec![])
    }
    async fn get_course_resources(
        ...
        Vec<crate::services::course::domain::UserResource>,
        AppError,
    > {
        Ok(vec![])
    }
    ...
    async fn get_user_resources(
        ...
        Vec<crate::services::course::domain::ResourceSummary>,
        AppError,
    > {
        Ok(vec![])
    }
    async fn get_resource_by_id(
        ...
        Option<crate::services::course::domain::UserResource>,
        AppError,
    > {
        Ok(None)
    }
    ...
    async fn create_user_resource(
        &self,
        resource: &crate::services::course::domain::UserResource,
    ) -> Result<crate::services::course::domain::UserResource, AppError>
    {
        Ok(resource.clone())
    }
...
impl crate::infra::StudySessionRepository for StubStudySessionRepository {
    async fn create(
        &self,
        session: &crate::services::study_session::study_session_domain::StudySession,
    ) -> Result<crate::services::study_session::study_session_domain::StudySession, AppError>
    {
        Ok(session.clone())
    }
    ...
    async fn list_by_course(
        ...
        Vec<crate::services::study_session::study_session_domain::StudySession>,
        AppError,
    >{
        Ok(vec![])
    }
...
#[allow(dead_code)]
pub fn stub_study_repositories(
) -> crate::services::StudyRepositories {
    crate::services::StudyRepositories {
...
/// Create a test StudyService with all required dependencies.
#[allow(dead_code)]
pub fn create_test_service() -> StudyService {
    StudyService::builder()
        .with_repositories(stub_study_repositories())
