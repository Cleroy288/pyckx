...
use crate::services::document_extractor::document_extractor_domain::ExtractedContent;
use crate::services::document_extractor::document_extractor_service::extract_txt;
