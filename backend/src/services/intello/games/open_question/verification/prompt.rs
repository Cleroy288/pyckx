...
use crate::services::intello::games::shared::prompt_helpers::get_language_name;
...
// ==> Builds AI prompt for grading open question answers
//
// @ input : VerificationPromptInput with answers to grade
// @ returns : Formatted prompt string for AI grading
