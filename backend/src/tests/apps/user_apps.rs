...
use crate::infrastructure::{
    AppRepository, CreateApp, SupabaseAppRepository, SupabaseUserAppRepository, UserAppRepository,
};
...
async fn test_user_app_lifecycle() {
    ...
    let app_repo = SupabaseAppRepository::new(&config);
    let user_app_repo = SupabaseUserAppRepository::new(&config);
