//! Study API — QCM CRUD operations

use super::{endpoints, helpers};
use crate::domain::game_types::StudyApiError;
use crate::domain::qcm_types::{
    GenerateQcmResponse, QcmSet,
...
/// Generate AI QCM from uploaded documents
/// POST /api/study/qcm/generate
pub async fn generate_qcm(
    form: &web_sys::FormData,
) -> Result<GenerateQcmResponse, String> {
    helpers::post_multipart(
        endpoints::QCM_GENERATE,
        form,
    )
    .await
}
