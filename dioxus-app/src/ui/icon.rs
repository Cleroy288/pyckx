//! Icon — SVG icon registry dispatched by name.
//!
//! `Icon { icon_name }` renders a named SVG. Unknown
//! names fall back to a square placeholder.

use dioxus::prelude::*;

/// SVG XML namespace (shared by every icon).
...
fn IconBook() -> Element {
    rsx! { svg {
        ...
        path { d: "M6.5 2H20v20H6.5A2.5 2.5 \
                   0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" }
    }}
}
...
fn IconTrash() -> Element {
    rsx! { svg {
        ...
        path { d: "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 \
                   1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 \
                   0 0 1 2 2v2" }
    }}
}
