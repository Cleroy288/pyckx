//! Intello shared types — Level enum, common fields
...
mod tests {
    ...
    #[test]
    fn test_intello_api_error_with_field() {
        let json = r#"{
            "error": "too short",
            "field": "name"
        }"#;
        let e: IntelloApiError =
    ...
    #[test]
    fn test_intello_api_error_without_field() {
