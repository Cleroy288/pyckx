  ...
  useEffect(() => {
    const fetchModels = async () => {
      try {
        ...
        // Fallback to empty - form will still work without model selection
      } finally {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">Choose which AI model generates your content</p>
      </div>
