  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        <div
          className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-md ${styles.iconBg} border`}
        >
          {icon}
        </div>
...
export function HomeView() {
  ...
  const createGames = [
    {
      ...
      variant: "create-manual" as const,
      actionLabel: "Create",
    },
    {
      id: "ai-qcm",
      title: "AI QCM",
      description: "Generate from documents",
      icon: <Sparkles className="h-4 w-4 text-primary" />,
      onClick: () => setView("create-ai-qcm"),
      variant: "create-ai" as const,
      actionLabel: "Generate",
    },
    {
      id: "ai-open",
      title: "AI Open Questions",
      description: "AI-graded answers",
      icon: <Sparkles className="h-4 w-4 text-primary" />,
    ...
    },
    {
      ...
      icon: <Sparkles className="h-4 w-4 text-primary" />,
      onClick: () => setView("create-ai-fill-blank"),
      variant: "create-ai" as const,
      actionLabel: "Generate",
    },
  ];
  ...
  const playGames = [
    ...
    {
      id: "play-order-phrase",
      title: "Order Phrase",
      description: "Arrange words",
      icon: <ListOrdered className="h-4 w-4 text-accent" />,
    ...
    },
    {
      ...
      title: "Fill Blank",
      description: "Complete phrases",
      icon: <TextCursor className="h-4 w-4 text-accent" />,
      onClick: handlePlayFillBlank,
      actionLabel: "Play",
    },
  ];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Create quizzes or play existing ones
          </p>
        </div>
      </div>
